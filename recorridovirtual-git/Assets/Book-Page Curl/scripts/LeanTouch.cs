...
namespace Lean
{
	// Si agrega este componente a su escena, convertirá todos los datos táctiles y del mouse en datos fáciles de usar
	[ExecuteInEditMode]
	[AddComponentMenu("Lean/Touch")]
	public class LeanTouch : MonoBehaviour
	{
		// Esto contiene la instancia actual de LeanTouch
		public static LeanTouch Instance;
		
		// Esta lista contiene todos los dedos actualmente activos (incluidos los simulados)
		public static List<LeanFinger> Fingers = new List<LeanFinger>();
		
		// Esta lista contiene todos los dedos actualmente inactivos (por ejemplo, esto permite agrupar y tocar)		
		public static List<LeanFinger> InactiveFingers = new List<LeanFinger>();
		
		// Contiene el delta de posición de pantalla combinado de todos los dedos
		...
		// Si multiplica este valor con cualquier otro delta de píxeles (por ejemplo, DragDelta), entonces será independiente de la resolución del dispositivo
		...
		// Esto devolverá SoloDragDelta después de que se haya ajustado al DPI actual
		...
		// Devuelve verdadero si se presiona cualquier botón del mouse
