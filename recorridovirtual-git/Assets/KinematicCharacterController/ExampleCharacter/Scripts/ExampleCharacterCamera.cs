...
namespace KinematicCharacterController.Examples
{
    public class ExampleCharacterCamera : MonoBehaviour
    {
        ...
        // Establezca la transformación que la cámara orbitará
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            if (FollowTransform)
            {
                ...
                // Entrada de rotacion del proceso
                if (Input.GetMouseButton(0))//Gabo (Solo rota si se preciona el boton del mouse)
                ...
                // Entrada de distancia de proceso
                ...
                // Encuentra la posición de seguimiento suavizada
                ...
                // Encuentra la posición de órbita de la cámara suavizada
