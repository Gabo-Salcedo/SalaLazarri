...
#pragma warning restore 0649
        ...
        /// <summary>
        /// Define el plano en el que está restringido el movimiento del personaje, si HasMovementConstraintPlane está activo
        /// </summary>
        ...
        /// <summary>
        /// La dirección hacia adelante del personaje (siempre actualizada durante la fase de actualización del personaje)
        /// </summary>
...
#pragma warning restore 0414 
        ...
        public void UpdatePhase1(float deltaTime)
        {
            ...
            if (_solveGrounding)
            {
                ...
                {
                    // Elija la distancia de sondeo de tierra adecuada
        ...
        public void UpdatePhase2(float deltaTime)
        {
                        ...
                        if (nbOverlaps > 0)
                        {
                            for (int i = 0; i < nbOverlaps; i++)
                            {
                                ...
                                if (Physics.ComputePenetration(
                                        ...
                                        out resolutionDistance))
                                {
                                    // Resolver a lo largo de la dirección de obstrucción
                                    Vector3 originalResolutionDirection = resolutionDirection;
                                    HitStabilityReport mockReport = new HitStabilityReport();
                                    mockReport.IsStable = IsStableOnNormal(resolutionDirection);
                                    resolutionDirection = GetObstructionNormal(resolutionDirection, mockReport);
            ...
            // Realizar el movimiento desde la velocidad base
        ...
        /// <summary>
        /// Sondeos para tierra válida y midifica la posición transitoria de entrada si se produce una toma de tierra
        /// </summary>
